# src/experiments/stacking/train_base_models.py
...
META_DATASET_PATH = "data/processed/meta_dataset.csv"
...
for model_name, model_cfg in config.items():
    log_file = os.path.join(LOG_DIR, f"stacking_model_{model_name}_v1.log")
    ...
    if model_type == "xgb":
        ...
        model_class = eval(model_cfg["class"])
    else:
